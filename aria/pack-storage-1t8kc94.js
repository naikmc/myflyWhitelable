...
//*******************
var e=require("../Aria"),t=require("../utils/Event"),i=require("./AbstractStorage"),r=require("../core/Browser");module.exports=e.classDefinition({$classpath:"aria.storage.HTML5Storage",$extends:i,$statics:{UNAVAILABLE:"%1 not supported by the browser."},$constructor:function(t,i,r){if(this.$AbstractStorage.constructor.call(this,t),this.type=i,this.storage=e.$window[i],this._browserEventCb=null,!this.storage&&r!==!1)throw this._disposeSerializer&&this.serializer&&this.serializer.$dispose(),this.$logError(this.UNAVAILABLE,[this.type]),new Error(this.type)},$destructor:function(){this.__target=null,this.$AbstractStorage.$destructor.call(this),this._listeners=null,this._checkListeners(),this.storage=null},$prototype:{_get:function(e){return this.storage.getItem(e)},_set:function(e,t){this.storage.setItem(e,t)},_remove:function(e){this.storage.removeItem(e)},_clear:function(){this.storage.clear()},_browserEvent:function(e){if(!aria.storage.EventBus.stop){var t=this.namespace?e.key.substring(0,this.namespace.length)===this.namespace:!0;if(t){var i=e.oldValue,r=e.newValue;if(i)try{i=this.serializer.parse(i)}catch(s){}if(r)try{r=this.serializer.parse(r)}catch(s){}this._onStorageEvent({name:"change",key:e.key,oldValue:i,newValue:r,url:e.url,namespace:this.namespace})}}},_checkListeners:function(){if(this.storage){var i=!!this._listeners,r=!!this._browserEventCb;i!==r&&(i?(this._browserEventCb={fn:this._browserEvent,scope:this},t.addListener(e.$window,"storage",this._browserEventCb)):(t.removeListener(e.$window,"storage",this._browserEventCb),this._browserEventCb=null))}},$addListeners:function(){this.$on.apply(this,arguments)},$on:function(e){r.isIE8&&this.$logWarn(this.UNAVAILABLE,"change event"),this.$AbstractStorage.$on.call(this,e),this._checkListeners()},$unregisterListeners:function(){this.$AbstractStorage.$unregisterListeners.apply(this,arguments),this._checkListeners()},$removeListeners:function(){this.$AbstractStorage.$removeListeners.apply(this,arguments),this._checkListeners()}}});
//*******************
